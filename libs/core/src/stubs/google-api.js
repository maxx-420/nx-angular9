...
// Mock for google maps api for testing
    ...
    apiLoad(
      [
        ...
        [
          ...
          [
            [
              "https://khms0.googleapis.com/kh?v=868\u0026hl=en-GB\u0026",
              "https://khms1.googleapis.com/kh?v=868\u0026hl=en-GB\u0026",
            ],
            null,
            null,
            null,
            ...
            "868",
            [
              "https://khms0.google.com/kh?v=868\u0026hl=en-GB\u0026",
              "https://khms1.google.com/kh?v=868\u0026hl=en-GB\u0026",
            ],
          ],
          null,
          null,
        ...
        [
          "https://maps.googleapis.com/maps-api-v3/api/js/41/3a/intl/en_gb",
          "3.41.3a",
        ],
        [3048760129],
        null,
        ...
        null,
        1,
        "https://khms.googleapis.com/mz?v=868\u0026",
        null,
...
*/
  ...
  Fa = function (a, b, c) {
    ...
    for (var d = a.length, e = 0; e < d; e++) {
      var f = a[e];
      if (b.call(c, f, e, a)) return { Cf: e, Lj: f };
    }
    return { Cf: -1, Lj: void 0 };
  };
  Ga = function (a, b, c) {
    if (null == a)
      throw new TypeError(
  ...
  _.ob = function (a) {
    return a instanceof _.nb && a.constructor === _.nb && a.o === mb
      ? a.j
  ...
  _.Fb = function () {
    return (
      _.Ab("Android") && !(Db() || _.Cb() || _.Ab("Opera") || _.Ab("Silk"))
    );
  };
  _.Hb = function () {
    this.j = "";
  ...
  _.Ib = function (a) {
    return a instanceof _.Hb && a.constructor === _.Hb && a.H === Gb
      ? a.j
      : "type_error:SafeHtml";
  };
  _.Jb = function (a, b) {
  ...
  _.Lb = function (a) {
    ...
    (b = a.ownerDocument && a.ownerDocument.defaultView) && b != _.z
      ? (b = Ka(b.document))
      : (null === Kb && (Kb = Ka(_.z.document)), (b = Kb));
  ...
  Zb = function (a, b) {
    return a === b
      ...
      : _.cb(a, function (c, d) {
          if (Vb(c)) {
            d = c;
            for (var e in d) if (((c = d[e]), !Yb(c, _.Wb(b, +e)))) return !1;
            return !0;
          }
          ...
          _.cb(b, function (c, d) {
            if (Vb(c)) {
              for (var e in c) if (null == _.Wb(a, +e)) return !1;
              return !0;
            }
  ...
  _.bc = function (a) {
    ...
    if (!b) {
      $b[a] = b = [];
      for (var c = (ac.lastIndex = 0), d; (d = ac.exec(a)); )
        (d = d[0]),
          (b[c++] = ac.lastIndex - d.length),
          (b[c++] = parseInt(d, 10));
      b[c] = a.length;
    }
    this.o = b;
  ...
  dc = function (a, b, c, d) {
    ...
    (d && null == a.value) ||
      ((a.af = b == e), (a.Si = 0 <= e && 0 < (4321 & (1 << (e - 75)))), c(a));
  };
  ec = function (a, b) {
    this.i = a[b];
  };
  ...
  _.Oc = function (a, b) {
    for (var c = _.Nc(void 0, _.Ec(b)), d = _.Nc(void 0, 0); d < c; ++d)
      a.push(b[d]);
  };
  _.Pc = function (a) {
  ...
  kd = function (a) {
    ...
    try {
      _.Yc({ height: _.id, width: _.id }, !0)(a);
    } catch (b) {
  ...
  Ae = function (a, b, c, d) {
    ...
    f
      ? (f.once = f.once && d)
      : a.Ga.push({ ee: b, context: c || null, once: d });
    e && a.j();
  };
  ...
  _.P = function (a) {
    return new Promise(function (b, c) {
      ...
      d.i[e]
        ? b(d.i[e])
        : ((d.j[e] = d.j[e] || []).push({ Cc: b, jd: c }), of(d, e));
    });
  };
  _.rf = function (a, b) {
    jf.i().i["" + a] = b;
  ...
  _.Kf = function (a, b, c) {
    function d(w) {
      ...
      w = J ? E[J] : w.id;
      if (null != w && !_.Pc(w) && !_.Rc(w))
        throw _.Wc((J || "id") + " is not a string or number");
  ...
  Pf = function (a) {
    ...
    this.element = hd(function () {
      return (
        _.fd(_.$c(Element, "Element"))(a.element) ||
      ...
      for (var e = d.next(); !e.done; e = d.next())
        (e = e.value),
          0 === e.indexOf("s.t:")
            ...
            ? (c.V[1] = ug[e.slice(4)])
            : 0 === e.indexOf("p.") &&
              ((e = e.slice(2).split(":")), vg[e[0]](e[1], c));
    }
  };
  xg = function (a) {
  ...
  Bg = function (a, b) {
    ...
    b &&
      b.pov &&
      ((a = b.pov),
      _.Pc(a.zoom) || (a.zoom = "number" === typeof b.zoom ? b.zoom : 1));
    this.setValues(b);
  ...
  Dg = function (a, b, c, d) {
    ...
    this.$ = new Bg(c, { visible: !1, enableCloseButton: !0, Ma: f });
  ...
  _.Eg = function (a, b, c) {
    ...
    this.j = c;
    this.i = {};
    for (a = 0; a < _.pc(_.H, 41); ++a)
      (b = new uc(_.oc(_.H, 41, a))), (this.i[_.F(b, 0)] = b);
  };
  _.Fg = function (a, b) {
  ...
  Sg = function (a) {
    ...
    if (!Og) {
      var c = (Og = { ha: "meummms" });
      if (!Pg) {
        var d = (Pg = { ha: "ebb5ss8MmbbbEI100b" });
        Qg || (Qg = { ha: "eedmbddemd", ma: ["uuuu", "uuuu"] });
        d.ma = [Qg, "Eb"];
      }
      d = Pg;
      Rg || (Rg = { ha: "10m", ma: ["bb"] });
  ...
  Vg = function (a, b, c) {
    new _.bc(b).forEach(function (d) {
      var e = d.xd,
        f = _.Wb(a, e);
      if (null != f)
        if (d.af) for (var g = 0; g < f.length; ++g) Ug(f[g], e, d, c);
        else Ug(f, e, d, c);
    });
  };
  Ug = function (a, b, c, d) {
  ...
  _.ah = function (a, b) {
    ...
    if (a) {
      ...
      d
        ...
        : ((this.offsetX = _.Zg || void 0 !== a.offsetX ? a.offsetX : a.layerX),
          (this.offsetY = _.Zg || void 0 !== a.offsetY ? a.offsetY : a.layerY),
  ...
  _.fh = function (a, b) {
    ...
    c in a.listeners &&
      ...
      (dh(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.i--));
  };
  gh = function (a, b, c, d) {
  ...
  xh = function (a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      ((d = _.Pa(d) ? !!d.capture : !!d), (c = jh(c)), a && a[kh])
    ...
    if ("number" !== typeof a && a && !a.Gc) {
      ...
      if (b && b[kh]) _.fh(b.H, a);
        ...
        b.removeEventListener
          ...
          : b.detachEvent
          ? b.detachEvent(th(c), d)
          : b.addListener && b.removeListener && b.removeListener(d);
        uh--;
        (c = mh(b))
          ? (_.fh(c, a), 0 == c.i && ((c.src = null), (b[qh] = null)))
          : dh(a);
      }
    }
  };
    ...
    if (!wh) {
      ...
      if (!(0 > d.keyCode || void 0 != d.returnValue)) {
        ...
        for (e = 0; !b.i && e < d.length; e++)
          (b.currentTarget = d[e]), (f = Bh(d[e], a, !1, b)), (c = c && f);
      }
      return c;
    }
            ...
            h &&
              ...
              e.o &&
                ...
                e.o.set({
                  image: e.j,
                  bounds: {
                    min: _.qd(g, { wa: h.Ja, Ca: h.Ia }),
                    max: _.qd(g, { wa: h.Pa, Ca: h.Oa }),
                  },
  ...
  di = function (a, b) {
    ...
    var d = a.rg();
    d &&
      (b && (c.parentNode || a.i.appendChild(c), a.o || _.Hg(c, d)),
      a.set("loading", !1));
  };
  ...
  ni = function (a, b) {
    ...
    if (!((_.z.devicePixelRatio && _.z.requestAnimationFrame) || _.Ag[43]))
      throw (
    ...
    _.P("util").then(function (m) {
      ...
      m.i.i(function (q) {
        _.P("controls").then(function (r) {
          r.yj(a, _.F(q, 1) || "http://g.co/dev/maps-no-account");
        });
      });
    });
    var f,
    ...
    var h = null,
      k = d.mapId || null;
    ki(d.useStaticMap, k, g) &&
      ((h = new bi(e, _.li, _.tc(), k)),
      h.set("size", g),
    ...
    _.P("map").then(function (c) {
      ...
      b.i.forEach(function (f) {
        var g = f.__gmimt,
          ...
          k = g.zoom,
          l = b.o(h, k);
        (g.Ge = d({ ya: h.x, Aa: h.y, Ka: k }, e, f, l, function () {
  ...
  Di = function (a) {
    if (Array.isArray(a) || a instanceof _.Ie)
      if (0 == _.Ec(a)) var b = !0;
        ...
        a instanceof _.Ie ? (b = a.getAt(0)) : (b = a[0]),
          (b = Array.isArray(b) || b instanceof _.Ie);
    else b = !1;
    return b
      ? a instanceof _.Ie
        ? Ci(zi)(a)
  ...
  Ni = function () {
    ...
    7 == this.type &&
      ...
      (d = b.exec(this.H))) &&
      ((this.type = 5),
      (this.version = new Ki(parseInt(d[1], 10), parseInt(d[2] || "0", 10))));
    6 == this.type &&
      ((b = /rv:([0-9]{2,}.?[0-9]+)/), (b = b.exec(this.H))) &&
      ((this.type = 1), (this.version = new Ki(parseInt(b[1], 10))));
    for (b = 1; 7 > b; ++b)
    ...
    if (5 == this.i || 6 == this.i || 2 == this.i)
      if ((b = /OS (?:X )?(\d+)[_.]?(\d+)/.exec(this.H)))
        this.T = new Ki(parseInt(b[1], 10), parseInt(b[2] || "0", 10));
    4 == this.i &&
  ...
  _.kj = function (a, b) {
    ...
    if (!(a instanceof _.L || a instanceof _.Id || a instanceof _.Ei))
      try {
        a = _.Ld(a);
      } catch (c) {
        try {
    ...
    e.prototype.delete = function (h) {
      ...
      return h.Yb && h.list
        ? (h.list.splice(h.index, 1),
          ...
          (h.Yb.md.next = h.Yb.next),
          (h.Yb.next.md = h.Yb.md),
          (h.Yb.head = null),
          this.size--,
          !0)
        : !1;
    ...
    for (
      ...
      if (43 == k || 38 == k) {
        ...
        if ((l = (_.Wj && _.Wj[l]) || null))
          for (
            l = l[Symbol.iterator](), c.Cg = !0, c.um = 38 == k, k = l.next();
            !k.done;
            k = l.next()
          )
            (k = k.value),
              (c.xd = k.Oc),
              (k = k.ie ? k.ie.j : k.Se ? k.Se.i : null),
              "string" === typeof k
                ? dc(c, k.charCodeAt(0), a, b)
                : k && ((c.ff = k.ma[0]), dc(c, 109, a, b));
      } else
        dc(c, k, a, b),
  ...
  _.hk = new _.nd({ Td: new _.md(256), Ud: void 0 });
  ...
  _.t.equals = function (a) {
    return a
      ? this.Ja == a.Ja && this.Ia == a.Ia && this.Pa == a.Pa && this.Oa == a.Oa
      : !1;
  };
  _.ik = _.sd(-Infinity, -Infinity, Infinity, Infinity);
  _.sd(0, 0, 0, 0);
  var vd = _.Yc({ lat: _.id, lng: _.id }, !0),
    Ad = _.Yc({ lat: Zj, lng: Zj }, !0);
  ...
  _.t.extend = function (a) {
    this.contains(a) ||
      (this.isEmpty()
        ? (this.i = this.j = a)
        : _.Fd(a, this.i) < _.Fd(this.j, a)
        ? (this.i = a)
        : (this.j = a));
  };
  _.t.equals = function (a) {
    return (
      1e-9 >= (Math.abs(a.i - this.i) % 360) + Math.abs(_.Gd(a) - _.Gd(this))
    );
  };
  _.t.center = function () {
  ...
  var Kd = _.Yc({ south: _.id, west: _.id, north: _.id, east: _.id }, !1);
  _.N = {
  ...
  _.N.addDomListener = function (a, b, c, d) {
    ...
    if (!a.addEventListener && a.attachEvent)
      return (c = new Vd(a, b, c, 2)), a.attachEvent("on" + b, Wd(c)), c;
  ...
  _.O.prototype.unbind = function (a) {
    var b = ce(this),
      c = b[a];
    c &&
      (c.li && delete Zd(c.qe, c.Fc)[_.Yd(c.li)],
      (this[a] = this.get(a)),
      (b[a] = null));
  };
  ...
  _.ye.prototype.removeListener = function (a, b) {
    this.Ga.length &&
      ((a = this.Ga.find(ze(a, b))) && this.Ga.splice(this.Ga.indexOf(a), 1),
  ...
  _.Ge(_.Ie.prototype, { length: null });
  ...
  var kk = _.Yc({ zoom: _.fd(Yj), heading: Yj, pitch: Yj });
  _.Ea(_.Oe, _.De);
...
*/
  ...
  var Fk = { Ro: "Point", Po: "LineString", POLYGON: "Polygon" };
  var Gk = {
    CIRCLE: 0,
  ...
  _.Mk = { LESS_WALKING: "LESS_WALKING", FEWER_TRANSFERS: "FEWER_TRANSFERS" };
  var Nk = new Set();
  ...
  _.Ea(Pf, Of);
  var Ok = _.Yc({ routes: _.bd(_.cd(_.Qc)) }, !0);
  var kf = {
    main: [],
    common: ["main"],
    util: ["common"],
  ...
  _.Hc(Pk.modules, Rk);
  delete Pk.modules;
  var Sk = _.Yc({ source: _.ak, webUrl: _.dk, iosDeepLinkId: _.dk });
  _.Ea(_.Uf, Pf);
  _.Uf.prototype.getAnchor = function () {
    return new _.I(0, 0);
  };
  _.Uf.prototype.Xa = _.sa(10);
  var Tk = _.ed(_.Yc({ placeId: _.dk, query: _.dk, location: _.Bd }), function (
    a
  ) {
    ...
    label: _.fd(
      _.dd([
        _.ak,
        {
          Oh: gd("text"),
          then: _.Yc(
            { text: _.ak, fontSize: _.dk, fontWeight: _.dk, fontFamily: _.dk },
            !0
          ),
        },
      ])
  ...
  _.Wf.prototype.map_changed = function () {
    ...
    this.__gm.set !== a &&
      ...
      (this.__gm.set = a) && _.Ke(a, this));
  };
  _.Wf.MAX_ZINDEX = 1e6;
  _.Ge(_.Wf.prototype, { map: _.dd([_.Hk, Uk]) });
  _.A(Xf, _.O);
  _.t = Xf.prototype;
  _.t.internalAnchor_changed = function () {
    ...
    a instanceof _.Wf
      ? Yf(this, "internalAnchorPosition", a, "internalPosition")
      : Yf(this, "internalAnchorPosition", a, "position");
  };
  ...
  _.Ge(_.gg.prototype, { map: _.Hk, url: null, bounds: null, opacity: _.ck });
  _.Wk = {
    UNKNOWN: "UNKNOWN",
    OK: _.ia,
  ...
  _.ig.prototype.fromPointToLatLng = function (a, b) {
    var c = this.H;
    return new _.L(
      _.ud(2 * Math.atan(Math.exp((a.y - c.y) / -this.o)) - Math.PI / 2),
      (a.x - c.x) / this.i,
      void 0 === b ? !1 : b
    );
  };
  ...
  _.Yk = new _.ig();
  _.A(_.jg, _.O);
  _.Ge(_.jg.prototype, { map: _.Hk });
  _.A(kg, _.O);
  _.Ge(kg.prototype, { map: _.Hk });
  _.A(lg, _.O);
  _.Ge(lg.prototype, { map: _.Hk });
  _.Zk = !!(
  ...
  _.al = new _.mg({ wa: 256, Ca: 256 }, 0, 0);
  _.A(pg, _.C);
  var Qg;
  _.A(qg, _.C);
  ...
  _.yg = { japan_prequake: 20, japan_postquake2010: 24 };
  _.cl = { NEAREST: "nearest", BEST: "best" };
  _.dl = { DEFAULT: "default", OUTDOOR: "outdoor" };
  _.A(Bg, _.Re);
  ...
  eh.prototype.add = function (a, b, c, d, e) {
    ...
    -1 < g
      ? ((b = a[g]), c || (b.qf = !1))
      : ((b = new ch(b, this.src, f, !!d, e)), (b.qf = c), a.push(b));
    return b;
  };
  ...
  _.Ge(ni.prototype, {
    ...
    restriction: function (a) {
      ...
      a = _.Yc({ strictBounds: _.ek, latLngBounds: _.Ld })(a);
  ...
  _.Wa(
    ...
    _.qi.preventMapHitsAndGesturesFrom
  );
  _.Ge(_.qi.prototype, {
    panes: null,
    projection: null,
  ...
  _.Ge(ri.prototype, { map: _.Hk });
  _.A(ti, _.O);
  ti.prototype.getTile = function (a, b, c) {
    if (!a || !c) return null;
    var d = _.ee("DIV");
    c = { Wa: a, zoom: b, Ge: null };
    d.__gmimt = c;
    _.Ke(this.i, d);
    if (this.j) {
      var e = this.tileSize || new _.K(256, 256),
        f = this.o(a, b);
      (c.Ge = this.j({ ya: a.x, Aa: a.y, Ka: b }, e, d, f, function () {
        _.N.trigger(d, "load");
      })).setOpacity(si(this));
    }
    return d;
  ...
  ti.prototype.releaseTile = function (a) {
    a &&
      this.i.contains(a) &&
      (this.i.remove(a), (a = a.__gmimt.Ge) && a.release());
  };
  ...
  _.Ge(ti.prototype, { opacity: _.ck });
  _.A(_.ui, _.O);
  ...
  _.A(_.vi, _.ui);
  _.A(wi, _.O);
  _.Ge(wi.prototype, { attribution: _.p(!0), place: _.p(!0) });
  ...
  _.Ji.prototype.getPanorama = function (a, b) {
    ...
    _.P("streetview").then(function (d) {
      _.P("geometry").then(function (e) {
        d.Cl(a, b, e.computeHeading, e.computeOffset, c);
      });
    });
  };
  ...
  var gj = {
    Animation: { BOUNCE: 1, DROP: 2, So: 3, Qo: 4 },
    BicyclingLayer: _.jg,
    Circle: _.Ei,
